...
if (window.MODE_ENDPOINT === 'GEMINI' && typeof window.fetch === 'function') {
...
window.addEventListener('load', async () => {
  ...
  function checkAppConfig(isLoginEvent = false) {
    if (window.MODE_ENDPOINT === 'GEMINI') return;
...
Trimakasih`
  ...
  if (shouldSkipVerification && foundEmail && !window.MODE_ENDPOINT === 'GEMINI') {
